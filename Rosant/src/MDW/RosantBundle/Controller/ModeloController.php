...
use MDW\RosantBundle\Entity\Modelo;
use MDW\RosantBundle\Form\ModeloType;
...
class ModeloController extends Controller
{
     ...
     * @Method("POST")
     * @Template("MDWRosantBundle:Modelo:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MDWRosantBundle:Modelo')->find($id);
     ...
     * @Method("PUT")
     * @Template("MDWRosantBundle:Modelo:edit.html.twig")
     */
