...
use MDW\RosantBundle\Entity\Marca;
use MDW\RosantBundle\Form\MarcaType;
...
class MarcaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MDWRosantBundle:Marca')->findAll();
     ...
     * @Method("POST")
     * @Template("MDWRosantBundle:Marca:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MDWRosantBundle:Marca')->find($id);
     ...
     * @Method("PUT")
     * @Template("MDWRosantBundle:Marca:edit.html.twig")
     */
