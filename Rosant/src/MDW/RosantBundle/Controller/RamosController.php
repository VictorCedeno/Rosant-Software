...
use MDW\RosantBundle\Entity\Ramos;
use MDW\RosantBundle\Form\RamosType;
...
class RamosController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MDWRosantBundle:Ramos')->findAll();
     ...
     * @Method("POST")
     * @Template("MDWRosantBundle:Ramos:new.html.twig")
     */
    public function createAction(Request $request)
    {
        $entity  = new Ramos();
        $form = $this->createForm(new RamosType(), $entity);
        $form->bind($request);
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MDWRosantBundle:Ramos')->find($id);
    ...
    public function editAction($id)
    {
        ...
        $editForm = $this->createForm(new RamosType(), $entity);
        $deleteForm = $this->createDeleteForm($id);
     ...
     * @Method("PUT")
     * @Template("MDWRosantBundle:Ramos:edit.html.twig")
     */
