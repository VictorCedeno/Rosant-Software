...
use MDW\RosantBundle\Entity\Role;
use MDW\RosantBundle\Form\RoleType;
...
class RoleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MDWRosantBundle:Role')->findAll();
     ...
     * @Method("POST")
     * @Template("MDWRosantBundle:Role:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MDWRosantBundle:Role')->find($id);
     ...
     * @Method("PUT")
     * @Template("MDWRosantBundle:Role:edit.html.twig")
     */
