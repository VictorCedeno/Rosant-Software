...
use MDW\RosantBundle\Entity\Vehiculos;
use MDW\RosantBundle\Form\VehiculosType;
...
class VehiculosController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MDWRosantBundle:Vehiculos')->findAll();
     ...
     * @Method("POST")
     * @Template("MDWRosantBundle:Vehiculos:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            $em->persist($entity);
            $em->flush();
             $this->get('session')->getFlashBag()->add('notice', 'Vehículo Registrado exitosamente!');
            $entity = new Vehiculos();
            $form= $this->createForm(new VehiculosType(), $entity);
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MDWRosantBundle:Vehiculos')->find($id);
     ...
     * @Method("PUT")
     * @Template("MDWRosantBundle:Vehiculos:edit.html.twig")
     */
