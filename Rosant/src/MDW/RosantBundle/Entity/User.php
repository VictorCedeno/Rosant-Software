<?php
    ...
    {  
        ...
        * Add user_roles
        *
        * @param Maycol\MiBundle\Entity\Role $userRoles
        */
        public function addRole(\Maycol\MiBundle\Entity\Role $userRoles)
        {
...
public function unserialize($serialized)
{
    list($this->id, $this->username, $this->password,
                    $this->salt, $this->user_roles) = \json_decode(
            $serialized);
}
